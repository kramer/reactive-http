...
public interface ErrorHandler {
    /**
     * Return a custom exception to be thrown for a {@link com.lyft.reactivehttp.HttpResponseException}. It is recommended that you
     ...
     *   &#64;Override public Throwable handleError(HttpResponseException cause) {
     ...
     * </pre>
     *
     * @param cause the original {@link HttpResponseException} exception
     * @return Throwable an exception which will be thrown from the client interface method. Must not
     *         be {@code null}.
     */
    Throwable handleError(HttpResponseException cause);
